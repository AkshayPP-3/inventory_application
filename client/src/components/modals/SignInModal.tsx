      ...
      <div className="relative w-full max-w-md rounded-2xl bg-linear-to-br from-white to-gray-50 p-8 shadow-2xl dark:from-gray-800 dark:to-gray-900">
        ...
        <div className="space-y-3">
          <button
            ...
            className="w-full flex items-center justify-center gap-2 rounded-lg border border-gray-200 bg-white px-4 py-2.5 font-medium text-gray-700 hover:bg-gray-50 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-200 dark:hover:bg-gray-600"
          >
